...
*   **Автоматический сбор данных**: Фоновый воркер парсит новые объявления с сайта и сохраняет их в базу данных.
...
| `LLM_MODEL` | Модель LLM | `stepfun/step-3.5-flash:free`(или другая модель)        |
